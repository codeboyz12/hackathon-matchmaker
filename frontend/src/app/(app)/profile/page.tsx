      ...
      <div className="flex flex-col w-full max-w-5xl mx-auto bg-white rounded-[2rem] border border-gray-200 shadow-sm overflow-hidden pb-10">
        ...
        <section className="relative w-full" aria-label="Cover photo and avatar">
          ...
          <div className="absolute -bottom-16 left-6 sm:left-12">
            <div className="w-32 h-32 rounded-full border-4 border-white overflow-hidden bg-white shadow-sm">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/avatar.png" alt="Profile Picture" className="w-full h-full object-cover" />
            </div>
          </div>
        </section>
        ...
        <section className="flex items-start justify-between w-full" aria-label="User information">
          <div className="text-left">
            <h1 className="text-2xl sm:text-3xl font-extrabold text-[#233876] tracking-tight">Murchy D.Luffy</h1>
        ...
        <section className="w-full">
          <div className="rounded-[1.25rem] border border-gray-200 bg-white p-8 min-h-[100px] flex items-center justify-center text-center">
            <p className="text-[#233876] font-medium text-base">
              ฉันจะเป็นราชาโจรสลัดให้ได้เลย เหมียวโอ่ง เริดเลยหละ
            </p>
          </div>
        </section>
        ...
        <div className="w-full flex flex-col lg:flex-row gap-8 mt-12 pt-8 border-t border-gray-100">
          <MyRoleSection 
            roles={["Frontend Dev", "Backend Dev", "AI Engineer", "Data Engineer"]} 
          />
          <SkillRankSection 
            skills={[
              { name: "React", rank: "gold" },
              { name: "Tailwind", rank: "bronze" },
              { name: "NextJS", rank: "gold" },
              { name: "SwiftUI", rank: "silver" },
              { name: "NodeJS", rank: "diamond" },
              { name: "Flutter", rank: "gold" },
              { name: "ExpressJS", rank: "bronze" },
              { name: "Python", rank: "gold" }
            ]} 
          />
        </div>
